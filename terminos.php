...
<div id="Marcobanner">
  <table width="303" border="0" align="center">
    <tr>
      <td width="273" align="center"><strong>Recordatorio</strong></td>
    </tr>
  </table><br />
...
<table width="456" border="0" align="center">
    <tr>
      <td width="446" align="center"><h3><font color="#FF0000"><strong><em>Recuerde que nuestro costo de envío aéreo mínimo es de 600 Bs. Por favor no enviar paquetes que contengan productos que esten valorados en el mercado venezolano por menos de este monto(ejm: Forros de teléfono, Protectores de pantalla, anti-rayones,chupones, medias etc). De enviarlo usted se hace responsable del paquete y acepta nuestro costo mínimo.</em></strong></font></h3></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td align="center">
      <form method="post" action="formulariodecompras.php">
        <input type="submit" name="acepto" id="acepto" value="Acepto los terminos" />
