...
<br /><br /><br /><br />
  <table width="362" border="0" align="center">
    <tr>
      <td><strong>Calcula</strong> <strong>el envio de tus paquetes a Venezuela</strong></td>
    </tr>
  </table>
</div><!--Fin de MARCO  BANNER -->
<div id="marcocontenidoregistro"><br />
  <table width="854" border="0" align="center">
    <tr>
      <td><form method="post" action="calcula.php">
        <table width="815" border="0" align="center">
          <tr>
            <td width="151">Envio Aereo:</td>
            <td width="24"><span id="sprytextfield1">
              <label for="largo"></label>
              <input name="largo" type="text" id="largo" size="4" />
              <span class="textfieldRequiredMsg">??.</span></span></td>
            <td width="13">x</td>
            <td width="24"><span id="sprytextfield2">
              <label for="alto"></label>
              <input name="alto" type="text" id="alto" size="4" />
              <span class="textfieldRequiredMsg">??.</span></span></td>
            <td width="17">x</td>
            <td width="44"><span id="sprytextfield3">
              <label for="ancho"></label>
              <input name="ancho" type="text" id="ancho" size="4" />
              <span class="textfieldRequiredMsg">??.</span></span></td>
            <td width="175">=Peso Volumetrico</td>
            <td width="221"><span id="sprytextfield4">
              <label for="peso"></label>
              <input name="peso" type="text" id="peso" size="4" />
              <span class="textfieldRequiredMsg">??.</span></span>Peso en Libras</td>
            <td width="108"><input type="submit" name="aereo" value="Calcular"/></td>
            </tr>
        </table>
      </form></td>
    </tr>
  ...
  <table width="783" border="0" align="center">
    <tr>
      <td width="706"><form method="post" action="calcula.php">
        <table width="642" border="0" align="center">
          <tr>
            <td width="186">Envio maritimo:</td>
            <td width="38"><label for="textfield"><span id="sprytextfield5">
              <input name="largo" type="text" id="largo" size="4" />
              <span class="textfieldRequiredMsg">??.</span></span></label></td>
            <td width="12">x</td>
            <td width="24"><span id="sprytextfield6">
              <label for="alto"></label>
              <input name="alto" type="text" id="alto" size="4" />
              <span class="textfieldRequiredMsg">??.</span></span></td>
            <td width="17">x</td>
            <td width="191"><span id="sprytextfield7">
              <label for="ancho"></label>
              <input name="ancho" type="text" id="ancho" size="4" />
              =Pie Cúbico<span class="textfieldRequiredMsg">??.</span></span></td>
            <td width="144"><input type="submit" value="Calcular" name="maritimo"/></td>
            </tr>
        </table>
      </form></td>
    </tr>
